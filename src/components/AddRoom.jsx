      ...
      <form onSubmit={handleSubmit} className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2 sm:col-span-2">
          ...
          <div className="flex flex-wrap gap-3">
            <label className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs text-slate-700 transition hover:border-slate-300">
              <input
                type="checkbox"
                checked={hasAC}
        ...
        <div className="sm:col-span-2">
          <button
            type="submit"
            className="inline-flex w-full items-center justify-center gap-1.5 rounded-xl bg-slate-900 px-4 py-2.5 text-xs font-medium text-white shadow-sm transition hover:bg-slate-800 active:translate-y-px sm:w-auto"
          >
            Add Room
          </button>
        </div>
